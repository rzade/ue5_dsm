...
class DSMPROJECT_API UBlueprintJsonObject : public UObject
{
	GENERATED_BODY()
private:
...
public:
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Parse Array String To Map", Keywords = "Json Parse Array String To Map", ShortTooltip = "Parses a Json Array String ([{\"some\": \"example\"}])"), Category = "Json|Object")
		static bool ParseToMap(FString JsonString, TArray<UBlueprintJsonObject*>& JsonArrayObject);
